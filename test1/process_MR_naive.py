...
ken_pkl = open("ken_naive_pkl.pkl", "wb")
s_pkl = open("s_naive_pkl.pkl", "wb")
nd_pkl = open("nd_naive_pkl.pkl", "wb")
p_pkl = open("p_naive_pkl.pkl", "wb")
...
f = open("result1_naive_mr.pkl", "wb")
res = Multi_Rank(10)
pickle.dump(res, f)
f.close()
